...
export function useLogin() : () => boolean{
    ...
    const performLogin = () => {
        let results : UserState = {id: "gadjlkj-gdag-gagda", firstName: "Jacob", lastName: "Gordon", email:"random@cox.net", phoneNumber: "4802500084", cart: {products: [{name: "T-Shirt", price: 14.99, itemNumber: 1315635}, {name: "Jeans", price: 16.99, itemNumber: 1315035}], totalPrice: 31.98 }, address: {state: "AZ", country: "US", zip: "85304", street: "4435 W. Sweetwater Ave", city: "Glendale"}}
